...
test_assign3_2: test_assign3_2.o dberror.o expr.o record_mgr.o rm_serializer.o storage_mgr.o buffer_mgr.o buffer_mgr_stat.o
	$(CC) $(CFLAGS) -o test_assign3_2 test_assign3_2.o dberror.o expr.o record_mgr.o rm_serializer.o storage_mgr.o buffer_mgr.o -lm buffer_mgr_stat.o
...
clean: 
	$(RM) recordmgr test_expr test_assign3_2 *.o *~
